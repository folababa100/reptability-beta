...
function mapStateToProps(state){
 ...
 class Plumbering extends Component{
    constructor(props){
        super(props)
        this.state={
            active:false
                    ...
                    <div>
                        <Grid columns="equal" className=" xcontainer">
                            ...
                            <Grid.Column computer="8" tablet="8" mobile="16" className="flex-justify">
                              <div>
                              <h1 className="ttbold darkblue-color">plumbering services</h1>
                                <p className="epistle blue-color tt">You can book a call for Electrical Servicing , Air Condition , Plumbing , CCTV , IT Service and Generator or any other home repair service requirement right from your home. It's quite easy and here's how it works.</p>
...
export default connect(mapStateToProps)(Plumbering)
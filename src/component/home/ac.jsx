                ...
                <section className="first-section">
                    ...
                    <div>
                        <Grid columns="equal" className=" xcontainer">
                            <Grid.Row >
                            <Grid.Column >
                                <Image src="../images/ss6.png" size="large" floated="right"/>
                            </Grid.Column>
                            <Grid.Column computer="8" tablet="8" mobile="16" className="flex-justify">
                              <div>
                              <h1 className="ttbold darkblue-color">air conditioning service</h1>
...
export default connect(mapStateToProps)(AC)
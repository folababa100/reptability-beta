                ...
                <section className="first-section">
                    ...
                    <div>
                        <Grid columns="equal" className=" xcontainer">
                            <Grid.Row >
                            <Grid.Column >
                                <Image src="../images/startup-03-image-01.png" size="large" floated="left"/>
                            </Grid.Column>
                            <Grid.Column computer="8" tablet="8" mobile="16" className="flex-justify">
                              <div>
                              <h1 className="ttbold darkblue-color">CCTV service</h1>
...
export default connect(mapStateToProps)(CCTV)